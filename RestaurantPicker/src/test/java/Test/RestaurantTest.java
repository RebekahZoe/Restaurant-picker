...
public class RestaurantTest {
	...
	public void ItalianTest() {
		...
		Assert.assertEquals(
				"https://www.tripadvisor.co.uk/Restaurant_Review-g186534-d8008321-Reviews-Jist_Misto-Glasgow_Scotland.html",
				response);
	...
	public void AmericanTest() {
		...
		String response = restaurantSystem.getResponse("Yes");
		Assert.assertEquals(
				"https://www.tripadvisor.co.uk/Restaurant_Review-g186534-d10814190-Reviews-Buck_s_Bar-Glasgow_Scotland.html",
				response);
		String response2 = restaurantSystem.getResponse("no");
		Assert.assertEquals("Do you want to choose another food?", response2);
	...
	public void MexicanTest() {
		...
		String response = restaurantSystem.getResponse("Yes");
		Assert.assertEquals(
				"https://www.tripadvisor.co.uk/Restaurant_Review-g186534-d6873873-Reviews-Topolabamba-Glasgow_Scotland.html",
				response);
		String response2 = restaurantSystem.getResponse("no");
		Assert.assertEquals("Do you want to choose another food?", response2);
	...
	public void IndianTest() {
		...
		String response = restaurantSystem.getResponse("Yes");
		Assert.assertEquals(
				"https://www.tripadvisor.co.uk/Restaurant_Review-g186534-d1509107-Reviews-Koolba-Glasgow_Scotland.html",
				response);
		String response2 = restaurantSystem.getResponse("no");
		Assert.assertEquals("Do you want to choose another food?", response2);
